    ...
    return (
        <div className="flex items-center justify-center flex-col">
            <div className={cn(
                ...
                <h1 className={"text-2xl md:text-6xl text-center text-neutral-800 pb-2"}>
                    Taskify helps teams move
                </h1>
                <div className={"text-3xl md:text-6xl bg-gradient-to-r from-fuchsia-600 to-pink-600 text-white px-4 p-3 rounded-md pb-4 w-fit"}>
                    work forward.
                </div>
            </div>
